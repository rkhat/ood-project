...
/**
 * The Parking Map class. Represents a parking map with a list of spots.
 *
...
public class ParkingMap implements Serializable {
  ...
  /**
   * Creates a ParkingMap object with the given spots and minimum width and
   * height.
   * 
   ...
   * @precondition X and Y coordinates of new spots must not overlap with any
   *               existing spots.
