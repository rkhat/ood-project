...
/**
 * Facade class that manages the state of the application (logged in member,
 * reservation, parking system, etc.)
 * 
...
public class Manager {
	 ...
	 * 
	 * @return A Map representing the list of vehicles.
	 */
	 ...
	 * Get the list of vehicles.
	 * 
	 * @return A List representing the list of vehicles.
	 */
	 ...
	 * 
	 * @return a String represting the list of vehicles.
	 */
