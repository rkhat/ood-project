...
class MemberTest {
  ...
  void testMember() {
    ...
    Assert.assertTrue(member.getUserName().equals(userName)
  ...
  void testRemoveCredits() {
    ...
    Assert.assertTrue(
        member.getCredits() == credits1 + credits2 - credits3 - credits4);
  }
  ...
  void testHasSufficientCredits() {
    ...
    Assert.assertTrue(
        !member.hasSufficientCredits(amt1) && member.hasSufficientCredits(amt2)
            && member.hasSufficientCredits(amt3));
  }
